    ...
    return (
        ...
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-20 flex flex-col items-end gap-3">
            ...
            >    
                ...
                <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
                    ...
                    onClick={() => setOpen(false)}>
                        <svg className="size-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            className="flex h-14 w-14 items-center justify-center rounded-full p-3 bg-linear-to-br from-black to-teal-600 text-white shadow-xl shadow-teal-700/50 transition duration-300 ease-in-out hover:scale-103">
                <svg aria-hidden="true" className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
