        ...
        <footer className="bg-teal-950 text-white/80 font-light py-5">
          ...
          <div className="flex flex-wrap md:gap-20 gap-10 justify-between w-[85%] mx-auto py-15">
            ...
            <div className="flex flex-wrap md:gap-20 gap-10 leading-12">
              <div className="">
                <ul>
                  <li><h4 className="font-heading text-white font-semibold tracking-[0.25em]">COMPANY</h4></li>
                  <Link href='/about'><li>About us</li></Link>
                  <Link href='/products'><li>Our offer</li></Link>
              ...
              <div className="">
                <ul>
                  <li><h4 className="font-heading text-white font-semibold tracking-[0.25em]">SOLUTIONS</h4></li>
              ...
              <div className="">
                <ul>
                  <li><h4 className="font-heading text-white font-semibold tracking-[0.25em]">CONTACT</h4></li>
