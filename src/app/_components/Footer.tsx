    ...
    return (
        ...
        <footer className="bg-teal-950 text-white/80 font-light py-5">
          ...
          <div className="flex flex-wrap md:gap-20 gap-10 justify-between w-[85%] mx-auto py-15">
            ...
            <div className="flex flex-col flex-wrap gap-3 h-full max-w-md">
              ...
              <Link href="/">
                <div className="flex items-center gap-x-2 text-white">
                    <svg className="text-teal-200 size-5 md:size-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              ...
              <div className="flex mt-auto h-full gap-5 pt-5 text-teal-200">
                <Link href='#' aria-label="EnerTrack on Facebook">
                  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 1024 1024">
                ...
                <Link href='#' aria-label="EnerTrack on LinkedIn">
                  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
                ...
                <Link href='#' aria-label="EnerTrack on Instagram">
                  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
                    <path d="M0 0h24v24H0z" fill="none" />
            ...
            {/* Sections column */}
            <nav aria-label="footer" className="flex flex-wrap md:gap-20 gap-10 leading-12">
                <ul>
