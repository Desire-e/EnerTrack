        ...
        <section className="flex flex-wrap lg:flex-row flex-col  w-full justify-between lg:divide-x-1 lg:divide-y-0 divide-y-1 divide-black/20">
            ...
            <div className="relative flex flex-col w-full lg:max-w-[55%] lg:px-10 py-10 overflow-hidden">
                <div className="relative z-10 flex flex-col gap-3 text-sm">
                    ...
                    <p>Our mission is to make energy consumption visible, understandable, and actionable.</p>
                    <p>We believe that businesses should have the information they need to manage energy efficiently. By turning real-time consumption data into clear insights, we help industrial teams reduce waste, control costs, and build more sustainable operations.</p>
                </div>
            ...
            <div className=" flex flex-col gap-5 w-full lg:max-w-[45%] lg:p-10 py-10">
                <div className="flex gap-3 items-center xl:p-5 p-3 bg-teal-700/5">
                ...
                <div className="flex gap-3 items-center p-5 bg-teal-700/5">
                    <svg  className="shrink-0 size-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
